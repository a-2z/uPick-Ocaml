...
let user5 = add_user "reetuparikh" "Reetu123" "Reetu"
let user6 = add_user "andrewzeng" "Andrew1" "Andrew"
let user7 = add_user "andrewosorio" "Andrew2" "Andrew"
let user8 = add_user "zachtegtmeier" "Zach123" "Zachary"
...
let get_visited_restaurants_test = []
