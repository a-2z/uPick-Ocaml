...
let make_response ?err_msg:(err_msg = "") = function
  | Some id -> respond' 
...
(**[load_json req ins_func insrter] inserts the contents of req
   into the database. [Body.to_string req.Request.body] is a string Ltw.t*)
